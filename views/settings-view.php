...
<!-- Main Settings Section start -->        
        ...
        <div class="container smtp-main-container  col-12">
            ...
            <li class="nav-item flex-sm-fill">
                <a id="home-tab" data-toggle="tab" href="#smtp" role="tab" aria-controls="home" aria-selected="true" class="nav-link border-0 text-uppercase font-weight-bold  <?php if(kauget('kau_form_submit',$_POST) == "kau_smtp_settings"){ echo "show active";}?> <?php if(kauget('kau_form_submit',$_POST) == "kau_smtp_reset_settings") echo "show active"?> <?php if(kauget('kau_form_submit',$_POST) == ""){ echo "show active";}?> ">SMTP Settings</a>
            </li>
            <li class="nav-item flex-sm-fill">
